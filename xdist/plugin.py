...
def pytest_addoption(parser):
    ...
    group.addoption(
        ...
        action="store", choices=['each', 'load', 'loadscope', 'topologyscope', 'no'],
        ...
        help=("set mode for distributing tests to exec environments.\n\n"
              ...
              "topologyscope: load balance by sending pending groups of tests in"
              " the same topology to any available environment.\n\n"
